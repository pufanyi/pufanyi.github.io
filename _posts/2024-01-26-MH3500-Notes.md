...
接下来我们考虑估计 $$\hat{\theta}$$ 的效率，首先我们来感性理解一下。当 $$n$$ 足够大的时候，考虑到 MLE 是 consistent 的，也就是说 $$\hat{\theta}-\theta_0\sim 0$$。于是我们有：

$$
\frac{\partial}{\partial\theta}\ell(\theta)\approx\frac{\partial}{\partial\theta}\ell(\theta_0) + \frac{\partial}{\partial\theta}\left(\frac{\partial}{\partial\theta}\ell\right)(\theta_0)\cdot(\theta-\theta_0)=\frac{\partial}{\partial\theta}\ell(\theta_0) + \frac{\partial^2}{\partial\theta^2}\ell(\theta_0)\cdot(\theta-\theta_0)
$$
