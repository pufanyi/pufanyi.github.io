...
<div class="l-page">
  <center>
    <iframe src="{{ 'assets/plotly/2024-01-26-MH3500-Notes/distributions/chi_square.html' | relative_url }}" frameborder='0' scrolling='no' height="500px" width="80%" style="border: 1px dashed grey;"></iframe>
  </center>
</div>
