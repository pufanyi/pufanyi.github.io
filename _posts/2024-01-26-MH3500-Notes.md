...
$$
\begin{aligned}
\mathbb{E}\left[\frac{\partial}{\partial\theta}\ell(\vec{x}\mid\theta)\right]&=\idotsint_{\mathbb{R}^n}\frac{\partial}{\partial\theta}\ell(x\mid\theta)\cdot f(\vec{x}\mid\theta)\mathrm{d}\vec{x}\\
