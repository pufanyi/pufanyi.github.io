...
首先我们需要知道一件事情，就是假设有一个 $$r$$，使得 $$M_{\boldsymbol{X}}(\boldsymbol{t})=M_{\boldsymbol{X}}(t_1, t_2, \dots, t_r, 0, \dots, 0)\cdot M_{\boldsymbol{X}}(0, \dots, 0, t_{r+1}, t_{r+2}, t_n)$$，那么 $$(t_1, t_2, \cdots, t_r)$$ 和 $$(t_{r+1}, t_{r+2}, \dots, t_n)$$ 是独立的。
