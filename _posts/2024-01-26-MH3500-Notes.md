...
<div class="l-page">
  <iframe src="{{ 'assets/plotly/distributions/gamma_distribution_change_alpha.html' | relative_url }}" frameborder='0' scrolling='no' height="300px" width="100%" style="border: 1px dashed grey;"></iframe>
</div>

<div class="l-page">
  <iframe src="{{ 'assets/plotly/distributions/gamma_distribution_change_beta.html' | relative_url }}" frameborder='0' scrolling='no' height="300px" width="100%" style="border: 1px dashed grey;"></iframe>
</div>
