...
<div class="l-page">
  <iframe src="{{ 'assets/plotly/2024-01-26-MH3500-Notes/distributions/gamma_distribution_change_alpha.html' | relative_url }}" frameborder='0' scrolling='no' height="300px" width="100%" style="border: 1px dashed grey;"></iframe>
</div>

<div class="l-page">
  <iframe src="{{ 'assets/plotly/2024-01-26-MH3500-Notes/distributions/gamma_distribution_change_beta.html' | relative_url }}" frameborder='0' scrolling='no' height="300px" width="100%" style="border: 1px dashed grey;"></iframe>
</div>
...
也就是 $$\frac{(n-1)S^2}{\sigma^2}\sim \chi_{n-1}^2$$。
