...
$$
\begin{aligned}
\mathbb{E}\left[\frac{\partial}{\partial\theta}\ell(\vec{x}\mid\theta)\right]&=\idotsint_{\vec{x}\in\mathbb{R}^n}\frac{\partial}{\partial\theta}\ell(x\mid\theta)\cdot f(\vec{x}\mid\theta)\mathrm{d}\vec{x}\\
&=\idotsint_{\vec{x}\in\mathbb{R}^n}\frac{\partial}{\partial\theta}\log f(x\mid\theta)\cdot f(\vec{x}\mid\theta)\mathrm{d}\vec{x}\\
&=\idotsint_{\vec{x}\in\mathbb{R}^n}\frac{\frac{\partial}{\partial\theta}f(x\mid\theta)}{f(x\mid\theta)}\cdot f(x\mid\theta)\mathrm{d}x\\
