...
<div class="l-page">
  <iframe src="{{ 'assets/plotly/distributions/gamma_distribution_change_alpha.html' | relative_url }}" frameborder='0' scrolling='no' height="500px" width="100%" style="border: 1px dashed grey;"></iframe>
</div>
...
=\ &\frac{1}{\sigma^2}\sum_{i=1}^n\left(\left(X_i-\overline{X}\right)+\left(\overline{X}-\mu\right)\right)^2\\
