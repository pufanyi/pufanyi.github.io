...
&=\frac{1}{\sigma^2}\sum_{i=1}^n\left(X_i-\overline{X}\right)^2+\frac{1}{\sigma^2}\sum_{i=1}^n\left(\overline{X}-\mu\right)^2+2\frac{1}{\sigma^2}\sum_{i=1}^n\left(X_i-\overline{X}\right)\left(\overline{X}-\mu\right)
\end{aligned}
$$
