...
$$
\begin{aligned}
F_{\sqrt{D/n}}(t)&=\mathbb{P}\left(\sqrt{\frac{D}{n}}\leq t\right)\\
&=\mathbb{P}\left(-nt^2\le D\leq nt^2\right)\\
&=\int_{-nt^2}^{nt^2}f_D(x)\mathrm{d}x\\
...
$$
\begin{aligned}
f_{\sqrt{D/n}}(t)&=\frac{\mathrm{d}F_{\sqrt{D/n}}(t)}{\mathrm{d}t}\\
&=\frac{1}{2^{\frac{n}{2}}\Gamma\left(\frac{n}{2}\right)}\cdot\frac{2ntx^{\frac{n}{2}-1}e^{-\frac{x}{2}}}{2}\\
&=\frac{ntx^{\frac{n}{2}-1}e^{-\frac{x}{2}}}{2^{\frac{n}{2}}\Gamma\left(\frac{n}{2}\right)}
\end{aligned}
$$
