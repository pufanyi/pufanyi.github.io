...
&=\frac{k^{\frac{k}{2}}}{\sqrt{2\pi}\cdot 2^{\frac{k}{2}-1}\cdot \Gamma\left(\frac{k}{2}\right)}\int_{-\infty}^{+\infty}{|y|}^ke^{-\frac{k(1+z^2)y^2}{2}}\mathrm{d}y\\
&=\frac{k^{\frac{k}{2}}}{\sqrt{2\pi}\cdot 2^{\frac{k}{2}}\cdot \Gamma\left(\frac{k}{2}\right)}\int_{0}^{+\infty}y^ke^{-\frac{k(1+z^2)y^2}{2}}\mathrm{d}y
\end{aligned}
$$
