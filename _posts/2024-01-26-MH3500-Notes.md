...
$$
M(t)=M(0)+M'(0)t+\frac{M''(0)}{2!}t^2+\epsilon(t)
$$
...
&=\left(M(0) + M'(0)\cdot t + M''(0)\cdot \frac{\left(\frac{t}{\sqrt{n}}\right)^2}{2}+\epsilon\left(\frac{t}{\sqrt{n}}\right)\right)^n
...
而 $$e^{\frac{t^2}{2}}$$ 就是 Normal Distribution 的 MGF，于是乎我们成功证明了 CLT。
