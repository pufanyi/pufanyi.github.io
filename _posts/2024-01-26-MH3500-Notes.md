...
$$
-\frac{\frac{\partial}{\partial\theta}\ell(\theta)}{\frac{\partial^2}{\partial\theta^2}\ell(\theta)}\to\mathcal{N}\left(\tilde{\mu}, \tilde{\sigma}^2)
$$
...
$$
\begin{aligned}
\mathbb{E}\left[\frac{\partial}{\partial\theta}\ell(x\mid\theta)\right]&=\int_{-\infty}^{\infty}\frac{\partial}{\partial\theta}\ell(x\mid\theta)\cdot f(x\mid\theta)\mathrm{d}x\\
