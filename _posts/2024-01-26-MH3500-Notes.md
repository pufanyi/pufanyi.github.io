...
我么想要算的是 likelihood function 的最大值，也就是说我们要找到一个 $$\hat\boldsymbol{\theta}$$ 使得：

$$
\left.\frac{\partial}{\partial\boldsymbol{\theta}}\mathcal{L}(\boldsymbol{x}\mid\boldsymbol{\theta})\right|_{\boldsymbol{\theta}=\hat{\boldsymbol{\theta}}}=0
$$
