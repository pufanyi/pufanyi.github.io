...
$$
\begin{aligned}
\mathbb{E}\left[\frac{\partial}{\partial\theta}\ell(\boldsymbol{x}\mid\theta)\right]&=\idotsint_{\mathbb{R}^n}\frac{\partial}{\partial\theta}\ell(x\mid\theta)\cdot f(\boldsymbol{x}\mid\theta)\mathrm{d}x\\
&=\idotsint_{\mathbb{R}^n}\frac{\partial}{\partial\theta}\log f(x\mid\theta)\cdot f(x\mid\theta)\mathrm{d}x\\
