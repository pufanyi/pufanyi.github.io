...
其中 $$C\sim N(0, 1)$$，$$D_k\sim \chi_k^2$$ 且 $$C$$ 和 $$D_k$$ 是独立的。
...
而我们知道在 $$n$$ 越来越大的时候，$$S$$ 是越来越趋向于 $$\sigma$$ 的，也就是说当 $$n$$ 变大的时候，$$t_{n}$$ 会越来越像 $$N(0, 1)$$。
...
（为啥自己推完一遍之后发现式子好像并没有之前上课时候看起来的那么丑

当然上课的时候老师表示其实这个式子是啥不重要，更重要的是 $$t$$ distribution 长啥样，以及它的性质。
...
&=f_{U_m}(mt)\cdot m\\
&=\frac{m\cdot t^{\frac{m}{2}-1}\cdot e^{-\frac{t}{2}}}{2^{\frac{m}{2}}\cdot \Gamma\left(\frac{m}{2}\right)}\\
\end{aligned}
$$
...
$$
f_{V_n/n}(t)=\frac{n\cdot t^{\frac{n}{2}-1}\cdot e^{-\frac{t}{2}}}{2^{\frac{n}{2}}\cdot \Gamma\left(\frac{n}{2}\right)}
$$
...
&=\int_0^{+\infty}t\cdot\frac{m\cdot (tw)^{\frac{m}{2}-1}\cdot e^{-\frac{tw}{2}}}{2^{\frac{m}{2}}\cdot \Gamma\left(\frac{m}{2}\right)}\cdot\frac{n\cdot t^{\frac{n}{2}-1}\cdot e^{-\frac{t}{2}}}{2^{\frac{n}{2}}\cdot \Gamma\left(\frac{n}{2}\right)}\mathrm{d}t\\
&=\frac{mn\cdot w^{\frac{w}{2}-1}}{2^{\frac{m+n}{2}}\cdot \Gamma\left(\frac{m}{2}\right)\cdot \Gamma\left(\frac{n}{2}\right)}\int_0^{+\infty}t^{\frac{m+n}{2}-1}\cdot e^{-\frac{(w+1)\cdot t}{2}}\mathrm{d}t\\
\end{aligned}
$$
...
$$
\begin{aligned}
f_F(w)&=\frac{mn\cdot w^{\frac{w}{2}-1}}{2^{\frac{m+n}{2}}\cdot \Gamma\left(\frac{m}{2}\right)\cdot \Gamma\left(\frac{n}{2}\right)}\int_0^{+\infty}t^{\frac{m+n}{2}-1}\cdot e^{-\frac{(w+1)\cdot t}{2}}\mathrm{d}t\\
&=\frac{mn\cdot w^{\frac{m}{2}-1}}{2^{\frac{m+n}{2}}\Gamma\left(\frac{m}{2}\right)\Gamma\left(\frac{n}{2}\right)}\int_{0}^{+\infty}\left(\frac{2u}{w+1}\right)^{\frac{m + n}{2} - 1}e^{-u}\cdot\frac{2}{w+1}\mathrm{d}u\\
&=\frac{mn\cdot w^{\frac{m}{2}-1}}{(w+1)^{\frac{m + n}{2}}\Gamma\left(\frac{m}{2}\right)\Gamma\left(\frac{n}{2}\right)}\int_{0}^{+\infty}u^{\frac{m+n}{2}-1}e^{-u}\mathrm{d}u\\ 
\end{aligned}
$$
