...
$$
\hat{\boldsymbol{\theta}}=\argmax_{\boldsymbol{\theta}}\mathcal{L}(\boldsymbol{x}\mid\boldsymbol{\theta})=\argmax_{\boldsymbol{\theta}}\ell(\boldsymbol{x}\mid\boldsymbol{\theta})=\argmin_{\boldsymbol{\theta}}\mathcal{H}(p, q_{\boldsymbol{\theta}})=\argmin_{\boldsymbol{\theta}}\mathrm{KL}(p\|q_{\boldsymbol{\theta}})
$$
