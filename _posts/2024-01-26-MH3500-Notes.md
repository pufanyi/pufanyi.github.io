...
&=\mathbb{E}\left(\hat{\theta}^2\right)-2\theta\mathbb{E}\left(\hat{\theta}\right)+\theta^2\\
&=\left[\mathbb{E}\left(\hat{\theta}^2\right)-\left(\mathbb{E}(\hat{\theta})\right)^2\right]+\left[\left(\mathbb{E}(\hat{\theta})\right)^2-2\theta\mathbb{E}\left(\hat{\theta}\right)+\theta^2\right]\\
