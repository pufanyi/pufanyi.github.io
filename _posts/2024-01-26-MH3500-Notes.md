...
$$
\mathbb{E}[\log f(x\mid\theta)]=\int_{-\infty}^{\infity}f(x\mid\theta_0)\cdot\log f(x\mid\theta)\cdot\mathrm{d}x
$$
...
$$
\begin{aligned}
\frac{\partial}{\partial\theta}\mathbb{E}[\log f(x\mid\theta)]&=\frac{\partial}{\partial\theta}\int_{-\infty}^{\infity}f(x\mid\theta_0)\cdot\log f(x\mid\theta)\cdot\mathrm{d}x\\
&=\int_{-\infty}^{\infity}\frac{\partial}{\partial\theta}f(x\mid\theta_0)\cdot\log f(x\mid\theta)\cdot\mathrm{d}x\\
&=\int_{-\infty}^{\infity}f(x\mid\theta_0)\cdot\frac{\partial}{\partial\theta}\log f(x\mid\theta)\cdot\mathrm{d}x\\
&=\int_{-\infty}^{\infity}f(x\mid\theta_0)\cdot\frac{\frac{\partial}{\partial\theta}f(x\mid\theta)}{f(x\mid\theta)}\mathrm{d}x\\
\end{aligned}
$$
