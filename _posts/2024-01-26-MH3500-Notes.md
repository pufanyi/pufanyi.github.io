...
就我们假设 $$Z_n=\frac{S_n}{\sigma\sqrt{n}}$$，$$X_i-\mu$$ 的 MGF 是 $$M(t)$$。

我们考虑：

$$
M_{S_n-n\mu}(t)=\left(M(t)\right)^n
$$
...
&=\mathbb{E}\left[e^{\frac{t}{\sigma\sqrt{n}}\left(S_n-\mu\right)}\right]\\
&=M_{S_n-n\mu}\left(\frac{t}{\sigma\sqrt{n}}\right)\\
