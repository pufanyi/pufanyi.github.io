...
=\ &\frac{1}{\sigma^2}\sum_{i=1}^n\left(X_i-\overline{X}+\overline{X}-\mu\right)^2\\
=\ &\frac{1}{\sigma^2}\sum_{i=1}^n\left(\left(X_i-\overline{X}\right)^2+2\left(X_i-\overline{X}\right)\left(\overline{X}-\mu\right)+\left(\overline{X}-\mu\right)^2\right)\\
=\ &\frac{1}{\sigma^2}\sum_{i=1}^n\left(X_i-\overline{X}\right)^2+\frac{2}{\sigma^2}\left(\overline{X}-\mu\right)\sum_{i=1}^n\left(X_i-\overline{X}\right)+\left(\frac{\overline{X}-\mu}{\sigma/\sqrt{n}}\right)^2\\
