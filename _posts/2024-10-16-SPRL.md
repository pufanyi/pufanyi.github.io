...
$$
\begin{aligned}
\mathbb{P}\left(T_0^r=\infty\right)&=1-\mathbb{P}\left(T_0^r<\infty\right)=1-\mathbb{E}\left[\mathbb{1}_{T_0^r<\infty}\right]\\
&=G(1)=1-\sqrt{1-4pq}=1-\sqrt{4p^2-4p+1}\\
&=1-\lvert 2p-1\rvert=2\min\{p, q\}
\end{aligned}
$$
