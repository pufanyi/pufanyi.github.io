...
考虑生成函数 $$G_n(s) = \mathbb{E}\left[s^{X_n}\mid X_0 = 1\right]$$ 表示第 $$n$$ 代的生成函数，我们有：
...
&=\lim_{s\to 1^-}\frac{\partial G_n(s)}{\partial s}\\
&=\lim_{s\to 1^-}\frac{\partial G_{n-1}(G_1(s))}{\partial G_1(s)}\cdot\frac{\partial G_1(s)}{\partial s}\\
&=\lim_{s\to 1^-}\frac{\partial G_{n-1}(G_1(s))}{\partial G_1(s)}\cdot\lim_{s\to 1^-}\frac{\partial G_1(s)}{\partial s}\\
&=\lim_{s\to 1^-}\frac{\partial G_{n-1}(s)}{\partial s}\cdot\lim_{s\to 1^-}\frac{\partial G_1(s)}{\partial s}\\
&=\mu_{n-1}\mu_1\\
&=\mu_1^n
\end{aligned}
$$
...
&= \left.\frac{1}{2}\frac{\partial^2G_n(s)}{\partial s^2}\right|_{s=1}\\
&= \left.\frac{1}{2}\frac{\partial}{\partial}\left(\frac{\partial}{\partial s} G_{n-1}(s)\cdot\frac{\partial}{\partial s}G_1(s)\right)\right|_{s=1}\\
&= \left.\frac{\partial^2}{\partial s^2}G_{n-1}(s)\cdot\frac{\partial}{\partial s}G_1(s)\right|_{s=1} + \left.\frac{\partial}{\partial s}G_n(s)\cdot\frac{\partial^2}{\partial s^2}G_1(s)\right|_{s=1}\\
$$
