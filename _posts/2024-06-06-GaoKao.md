...
$$
\frac{\mathrm{d}}{\mathrm{d}x}f(x)=a^x\ln a-b
$$

$$\frac{\mathrm{d}^2}{\mathrm{d}x^2}f(x)a^x\ln^2 a>0$$, $$f'(x)$$ is an strictly increasing function.
...
| $$x$$ | $$f'(x)$$ | $$f(x)$$ |
| :--: | :--: | :--: |
| $$x\in\left(-\infty, \frac{b}{\ln a}\right)$$ | $$f'(x)<0$$ | $$f(x)$$ is decreasing |
| $$x=\frac{b}{\ln a}$$ | $$f'(x)=0$$ | $$f(x)$$ has a local minimum |
| $$x\in\left(\frac{b}{\ln a}, +\infty\right)$$ | $$f'(x)>0$$ | $$f(x)$$ is increasing |
