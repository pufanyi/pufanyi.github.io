...
$$
f\left(\log_a\frac{b}{\ln a}\right)=f\left(\ln b\right)=e^{\ln b}-b\ln b+e^2=b(1-\ln b)+e^2
$$

When $$b>e^4$$,

$$
\frac{\partial}{\partial b}b(1-\ln b)+e^2=1-\ln b-1=-\ln b < 0
$$

So

$$
f\left(\log_a\frac{b}{\ln a}\right)=b(1-\ln b)+e^2 < e^4(1-\ln e^4)+e^2=e^2-3e^4 < 0
$$
