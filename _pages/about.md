...
I am currently doing research at [SenseTime](https://www.sensetime.com/en) and [MMLab@NTU](https://www.mmlab-ntu.com/). I am fortunate to be supervised by [Prof. Ziwei Liu](https://liuziwei7.github.io/), I am also grateful for the extensive help I have received from [Bo Li](https://brianboli.com/), [Zhongang Cai](https://caizhongang.com/) and [Lei Yang](https://scholar.google.com/citations?user=jZH2IPYAAAAJ&hl=en). My research interests currently lie in multi-modality (unified) models and spatial intelligence.
